...
extern "C" {
    ...
    void draw_example_lanes(WorldData * world, i32 lane_example_index)
    {
        ...
        if (lane_example_index == 1)
        {
            ...
            const Rectangles3 example_rectangles3[2] = {
                { {200, 100, 100, 50}, {450, 200, 80, 150}, {200, 400, 100, 50} },
                { {850, 100, 100, 50}, {600, 200, 80, 150}, {850, 400, 100, 50} },
            };
            ...
            for (i32 example_rectangles3_index = 0; example_rectangles3_index < nr_of_example_rectangles3; example_rectangles3_index++)
            {
                ...
                if (example_rectangles3_index == 0)
                {
                    ...
                    hor_line = get_top_line_from_rect(rects.middle);
                    vert_line = get_right_line_from_rect(rects.top);
                    draw_cornered_lane_segment(hor_line, vert_line, bending_radius, line_color, unselected_color, line_width);
                }
                else
                {
                    HorLine hor_line = get_bottom_line_from_rect(rects.middle);
                    VertLine vert_line = get_left_line_from_rect(rects.bottom);
                    draw_cornered_lane_segment(hor_line, vert_line, bending_radius, line_color, unselected_color, line_width);
                    
                    hor_line = get_top_line_from_rect(rects.middle);
                    vert_line = get_left_line_from_rect(rects.top);
                    draw_cornered_lane_segment(hor_line, vert_line, bending_radius, line_color, unselected_color, line_width);
                }
