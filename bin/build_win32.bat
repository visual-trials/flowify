...
cl /EHsc /Od /Zi -wd4576 /Fddist\vc.pdb src\platform\win32_main.cpp User32.lib d2d1.lib Dwrite.lib Msimg32.lib Comdlg32.lib /DDO_ASSERTIONS=1 /DINCLUDE_PROJECT_FILE="\"../%PROJECT_NAME%.c\"" /Fodist\%PROJECT_NAME%.obj /Fedist\%PROJECT_NAME%.exe
