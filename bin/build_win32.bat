...
cl /EHsc /Od /Zi -wd4576 /Fddist\vc.pdb src\platform\win32_main.cpp User32.lib d2d1.lib Dwrite.lib Msimg32.lib Comdlg32.lib /DINCLUDE_PROJECT_FILE="\"../%PROJECT_NAME%.cpp\"" /Fodist\%PROJECT_NAME%.obj /Fedist\%PROJECT_NAME%.exe
