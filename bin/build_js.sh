...
emcc src/flowify.cpp -Os -s WASM=1 -o dist/flowify.html --js-library web/js/emcc/external.js -s "EXPORTED_FUNCTIONS=['_init_world', '_update_frame', '_render_frame', '_set_left_mouse_button_data', '_set_right_mouse_button_data', '_set_mouse_wheel_data', '_set_mouse_position_data', '_set_ctrl_key_data', '_set_shift_key_data', '_set_alt_key_data', '_set_other_key_data']"
